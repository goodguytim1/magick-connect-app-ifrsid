...
// Magick Mixer Expansion
{ id: 'mm21', deckId: 'magickmixer', type: 'question', prompt: 'Take 2 sips if you\'ve made a bad decision knowingly', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm22', deckId: 'magickmixer', type: 'question', prompt: 'Take a sip for each person you\'d date here', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm23', deckId: 'magickmixer', type: 'question', prompt: 'Everyone drinks if you\'ve lied to protect someone', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm24', deckId: 'magickmixer', type: 'question', prompt: 'Take a shot if you were the problem once', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm25', deckId: 'magickmixer', type: 'question', prompt: 'Point to the biggest flirt - they drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm26', deckId: 'magickmixer', type: 'question', prompt: 'Who falls in love fastest? They drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm27', deckId: 'magickmixer', type: 'question', prompt: 'Call out someone with toxic energy - they drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm28', deckId: 'magickmixer', type: 'question', prompt: 'Pick someone who gets attention - they drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm29', deckId: 'magickmixer', type: 'question', prompt: 'Choose someone with secrets - they drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm30', deckId: 'magickmixer', type: 'question', prompt: 'Say your toxic trait, take a shot', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm31', deckId: 'magickmixer', type: 'question', prompt: 'Reveal your last situationship, sip', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm32', deckId: 'magickmixer', type: 'question', prompt: 'Say something wild you did, drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm33', deckId: 'magickmixer', type: 'question', prompt: 'Reveal your type, matching person drinks', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm34', deckId: 'magickmixer', type: 'question', prompt: 'Say your red flag, group decides your drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm35', deckId: 'magickmixer', type: 'question', prompt: 'Everyone drinks if they\'ve kissed someone they regret', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm36', deckId: 'magickmixer', type: 'question', prompt: 'Last to drink takes extra shot', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm37', deckId: 'magickmixer', type: 'question', prompt: 'Everyone drinks except one chosen person', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm38', deckId: 'magickmixer', type: 'question', prompt: 'Point to most likely to cheat - they drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm39', deckId: 'magickmixer', type: 'question', prompt: 'First to laugh drinks', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm40', deckId: 'magickmixer', type: 'question', prompt: 'Give out 3 sips', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm41', deckId: 'magickmixer', type: 'question', prompt: 'Swap drinks with someone', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm42', deckId: 'magickmixer', type: 'question', prompt: 'Skip a drink but double next', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm43', deckId: 'magickmixer', type: 'question', prompt: 'Make a rule, breakers drink', tags: ['social', 'fun', 'icebreaker', '21+'] },
{ id: 'mm44', deckId: 'magickmixer', type: 'question', prompt: 'Pick someone to drink with you all round', tags: ['social', 'fun', 'icebreaker', '21+'] },

// Midnight Magick Expansion
{ id: 'mdm39', deckId: 'midnightmagick', type: 'question', prompt: 'What\'s something you\'d want to do with someone but wouldn\'t say first?', tags: ['curiosity', 'exploration', 'fantasy', 'desires'] },
{ id: 'mdm40', deckId: 'midnightmagick', type: 'question', prompt: 'What kind of energy makes you lose control a little?', tags: ['curiosity', 'exploration', 'energy', 'growth'] },
{ id: 'mdm41', deckId: 'midnightmagick', type: 'question', prompt: 'Do you prefer slow tension or instant chemistry?', tags: ['desire', 'playful', 'foreplay', 'preferences'] },
{ id: 'mdm42', deckId: 'midnightmagick', type: 'question', prompt: 'What subtle thing turns you on instantly?', tags: ['flirting', 'desire', 'arousal', 'chemistry'] },
{ id: 'mdm43', deckId: 'midnightmagick', type: 'question', prompt: 'Have you ever had unspoken tension with someone?', tags: ['chemistry', 'tension', 'desire', 'history'] },
{ id: 'mdm44', deckId: 'midnightmagick', type: 'question', prompt: 'What makes someone unforgettable to you?', tags: ['desire', 'attraction', 'psychology', 'memory'] },
{ id: 'mdm45', deckId: 'midnightmagick', type: 'question', prompt: 'Do you prefer being wanted or doing the wanting?', tags: ['desire', 'attraction', 'dynamics', 'validation'] },
{ id: 'mdm46', deckId: 'midnightmagick', type: 'question', prompt: 'What\'s the difference between lust and connection?', tags: ['chemistry', 'connection', 'sex', 'emotional'] },
{ id: 'mdm47', deckId: 'midnightmagick', type: 'question', prompt: 'When do you feel most confident in your body?', tags: ['confidence', 'body-image', 'desire', 'self-awareness'] },
{ id: 'mdm48', deckId: 'midnightmagick', type: 'question', prompt: 'What builds trust in intimacy for you?', tags: ['trust', 'intimacy', 'safety', 'connection'] },
{ id: 'mdm49', deckId: 'midnightmagick', type: 'question', prompt: 'What makes you feel safe opening up?', tags: ['vulnerability', 'trust', 'emotional', 'safety'] },
{ id: 'mdm50', deckId: 'midnightmagick', type: 'question', prompt: 'What kind of touch means more than physical?', tags: ['touch', 'intimacy', 'emotional', 'connection'] },
{ id: 'mdm51', deckId: 'midnightmagick', type: 'question', prompt: 'What do people misunderstand about your desires?', tags: ['desire', 'identity', 'communication', 'self-awareness'] },
{ id: 'mdm52', deckId: 'midnightmagick', type: 'question', prompt: 'What makes intimacy meaningful for you?', tags: ['intimacy', 'emotional', 'sex', 'connection'] },

// Adventure Sparks Expansion
{ id: 'as26', deckId: 'adventuresparks', type: 'mission', prompt: 'Create a shared playlist and drive with no destination.', tags: ['travel', 'spontaneous', 'adventure'] },
{ id: 'as27', deckId: 'adventuresparks', type: 'mission', prompt: 'Flip a coin to decide your direction for 20 minutes.', tags: ['spontaneous', 'adventure', 'exploration'] },
{ id: 'as28', deckId: 'adventuresparks', type: 'mission', prompt: 'Explore a place neither of you has been.', tags: ['exploration', 'walking', 'discovery'] },
{ id: 'as29', deckId: 'adventuresparks', type: 'mission', prompt: 'Create a full experience with a $10 budget.', tags: ['spontaneous', 'adventure', 'exploration'] },
{ id: 'as30', deckId: 'adventuresparks', type: 'mission', prompt: 'Take a ride somewhere random and explore.', tags: ['spontaneous', 'exploration', 'adventure'] },

// Creative Charms Expansion
{ id: 'cc26', deckId: 'creativecharms', type: 'mission', prompt: 'Buy a Polaroid or disposable camera and create a mini photoshoot.', tags: ['photography', 'creative', 'memory'] },
{ id: 'cc27', deckId: 'creativecharms', type: 'mission', prompt: 'Recreate a movie scene together in public.', tags: ['social-media', 'creative', 'fun'] },
{ id: 'cc28', deckId: 'creativecharms', type: 'mission', prompt: 'Dress in a themed outfit and go out together.', tags: ['social-media', 'creative', 'fun'] },
{ id: 'cc29', deckId: 'creativecharms', type: 'mission', prompt: 'Create a "day in the life" vlog together.', tags: ['social-media', 'creative', 'fun'] },
{ id: 'cc30', deckId: 'creativecharms', type: 'mission', prompt: 'Record a 1-minute "future memory" message.', tags: ['conversation', 'creative', 'fun'] },
{ id: 'cc31', deckId: 'creativecharms', type: 'mission', prompt: 'Cook a meal together under $15.', tags: ['cooking', 'fun', 'challenge'] },
{ id: 'cc32', deckId: 'creativecharms', type: 'mission', prompt: 'Capture one photo that defines your day.', tags: ['photography', 'memory', 'reflection'] },

// Mirror Quests Expansion
{ id: 'mq26', deckId: 'mirrorquests', type: 'mission', prompt: 'Buy a plant under $20 and take care of it together.', tags: ['self-expression', 'gift', 'creative'] },
{ id: 'mq27', deckId: 'mirrorquests', type: 'mission', prompt: 'Buy matching symbolic items.', tags: ['self-expression', 'gift', 'creative'] },
{ id: 'mq28', deckId: 'mirrorquests', type: 'mission', prompt: 'Ask each other 3 questions never asked before.', tags: ['vulnerability', 'trust', 'deep'] },
{ id: 'mq29', deckId: 'mirrorquests', type: 'mission', prompt: 'Talk about your future in detail.', tags: ['reflection', 'future', 'bonding'] },
{ id: 'mq30', deckId: 'mirrorquests', type: 'mission', prompt: 'Write one sentence about how the other made you feel.', tags: ['appreciation', 'bonding', 'positive'] },
{ id: 'mq31', deckId: 'mirrorquests', type: 'mission', prompt: 'Leave something meaningful behind for someone else.', tags: ['kindness', 'giving', 'positive'] },
{ id: 'mq32', deckId: 'mirrorquests', type: 'mission', prompt: 'Rate the experience and explain why.', tags: ['reflection', 'conversation', 'closure'] },

// Bond Quests Expansion
{ id: 'bq26', deckId: 'bondquests', type: 'mission', prompt: 'Ask 3 strangers for recommendations and follow one.', tags: ['social', 'adventure', 'discovery'] },
{ id: 'bq27', deckId: 'bondquests', type: 'mission', prompt: 'Compliment 5 strangers genuinely.', tags: ['kindness', 'giving', 'social'] },
{ id: 'bq28', deckId: 'bondquests', type: 'mission', prompt: 'Ask a couple how they met.', tags: ['social', 'conversation', 'connection'] },
{ id: 'bq29', deckId: 'bondquests', type: 'mission', prompt: 'Start a conversation with a stranger for 3 minutes.', tags: ['social', 'conversation', 'connection'] },
{ id: 'bq30', deckId: 'bondquests', type: 'mission', prompt: 'Perform something small in public.', tags: ['performance', 'creative', 'bold'] },
{ id: 'bq31', deckId: 'bondquests', type: 'mission', prompt: 'Act like you\'re filming a documentary.', tags: ['exploration', 'fun', 'perspective'] },
{ id: 'bq32', deckId: 'bondquests', type: 'mission', prompt: 'Recreate your ideal first date.', tags: ['romantic', 'date', 'connection'] },
{ id: 'bq33', deckId: 'bondquests', type: 'mission', prompt: 'Create a moment you\'ll both remember forever.', tags: ['memory', 'bonding', 'signature'] },
